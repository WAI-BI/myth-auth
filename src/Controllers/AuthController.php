...
class AuthController extends Controller
{
	...
	public function attemptForgot()
	{
        ...
        if (!isset($user->reset_hash) || empty($user->reset_hash)) {
	...
	public function attemptReset()
	{
		...
		return redirect()->route('login')->with('message', 'La password è stata correttamente aggiornata.<br>Utilizza le nuove credenziali per accedere alla piattaforma.');


		// Redirect al login QUI 

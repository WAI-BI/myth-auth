          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="p-5">
                ...
                <p><?=lang('Platone.inserisci_codice_otp')?></p>



                <form class="user" action="<?php echo base_url("/sms_otp/".$username); ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($config->requireSMSOTP !== null) : ?>
                          <p><a href="<?=base_url('sms_otp_resend/'.$username)?>"><?=lang('Platone.non_hai_ricevuto_sms')?></a></p>
                        <?php endif; ?>
                </form>
                <script>

...
return [
    ...
    "activationUuidSuccess" =>  "Per proseguire indica il GUID che trovi nell'area riservata OAM",
    "invita_uuid"   =>  "Invia GUID",
    "uuid"  =>  "GUID",
    "inserisci_codice_uuid" =>  "Per proseguire recupera il codice GUID presente nella tua area privata OAM e inserisci il codice nella FORM sottostante.",
    "error_during_uuid_confirm" =>  "Errore di autenticazione con IL GUID fornito.",

...
class AuthUserSmsOtpAttempts extends Migration
{
	public function up()
	{
		$this->forge->addField([
        ...
        $this->forge->createTable('auth_user_sms_otp_attempts', true);
	}

	public function down()
	{
		//
        $this->forge->dropTable('auth_user_sms_otp_attempts', true);
